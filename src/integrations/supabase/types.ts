    ...
    Tables: {
      ...
      invoice_items: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "invoice_items_project_work_id_fkey"
            columns: ["project_work_id"]
            isOneToOne: false
      ...
      project_works: {
        ...
        Relationships: [
          {
            foreignKeyName: "project_works_project_block_id_fkey"
          ...
          {
            foreignKeyName: "project_works_work_id_fkey"
            columns: ["work_id"]
            isOneToOne: false
